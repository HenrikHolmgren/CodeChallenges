...
namespace WindowsillSoft.AdventOfCode.AoC2018.Solutions.Day12
{
    public class Day12Solver : AoC2018SolverBase
    {
        private string _initialState;
        private HashSet<string> _livePatterns;

        public override string Description => "Day 12: Subterranean Sustainability";
