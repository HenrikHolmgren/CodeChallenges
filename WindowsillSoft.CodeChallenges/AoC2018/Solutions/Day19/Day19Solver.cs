...
namespace WindowsillSoft.AdventOfCode.AoC2018.Solutions.Day19
{
    public class Day19Solver : AoC2018SolverBase
    {
        private ElfCodeMachine.Register _instructionPointer;
        private ElfCodeMachine.Operation[] _instructions;

        public override string Description => "Day 19: Go With The Flow";
