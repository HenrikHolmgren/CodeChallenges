...
namespace WindowsillSoft.AdventOfCode.AoC2018.Solutions.Day3
{
    public class Day3Solver : AoC2018SolverBase
    {
        public override string Description => "Day 3: No Matter How You Slice It";
