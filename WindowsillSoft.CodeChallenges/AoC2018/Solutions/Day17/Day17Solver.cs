...
namespace WindowsillSoft.AdventOfCode.AoC2018.Solutions.Day17
{
    public class Day17Solver : AoC2018SolverBase
    {
        private int _minY;
        private char[,] _field;

        public override string Description => "Day 17: Reservoir Research";
