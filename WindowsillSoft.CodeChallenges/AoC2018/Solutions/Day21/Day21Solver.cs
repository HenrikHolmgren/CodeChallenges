...
namespace WindowsillSoft.AdventOfCode.AoC2018.Solutions.Day21
{
    public class Day21Solver : AoC2018SolverBase
    {
        private ElfCodeMachine.Register _instructionPointer;
        private ElfCodeMachine.Operation[] _instructions;

        public override string Description => "Day 21: Chronal Conversion";
